...
const Banner = () => {
    return (
        <div className='bg-banner relative'>
            <div className='border-image absolute bottom-1/4 left-1/4 md:w-72 md:h-72 w-56 h-56'>
                <div className='w-full h-full flex flex-col justify-between bottom-4 left-4 md:bottom-1/4 md:left-1/4 bg-[#241d1d7a]'>
                    <h1 className='text-center lg:text-7xl text-3xl font-bold break-words text-[#239abe]'>BooM Autos</h1>
