...
const Footer = () => {
    return (
        <div>
            <footer className="footer md:place-content-between  place-content-center p-10 bg-slate-600 text-slate-300 ">
                <div>
            ...
            <footer className="footer md:place-content-between  place-content-center px-10 py-4 bg-slate-500 text-slate-300 border-base-300">
